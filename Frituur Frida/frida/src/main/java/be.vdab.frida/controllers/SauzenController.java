...
class SauzenController {
    ...
    private final Saus[] alleSauzen = {
            new Saus(1, "cocktail", List.of(new String[]{"mayonasie", "ketchup", "cognac"})new Saus(1, "cocktail", List.of(new String[]{"mayonasie", "ketchup", "cognac"})),
    ...
    */
    ...
    public ModelAndView findByNummer(@PathVariable long nummer) {
        ...
        sausService.findById(nummer).ifPresent(gevondenSaus ->
